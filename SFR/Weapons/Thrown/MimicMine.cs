...
internal sealed class MimicMine : TWeapon
{
    internal MimicMine()
    {
        TWeaponProperties weaponProperties = new(115, "Mimic_Mine", "WpnMimicMine", false, WeaponCategory.Supply)
        {
            ...
            ThrowObjectID = "WpnMimicMineThrown",
            DrawSoundID = "GrenadeDraw",
            VisualText = "Mimic Mine"
        };
        ...
        weaponVisuals.SetModelTexture("MimicMineM");
        weaponVisuals.SetDrawnTexture("MimicMineM");
    ...
    private MimicMine(TWeaponProperties weaponProperties, TWeaponVisuals weaponVisuals)
    {
        SetPropertiesAndVisuals(weaponProperties, weaponVisuals);
    ...
    public override TWeapon Copy() => new MimicMine(Properties, Visuals)
    {
